...
class SpaApp {
            ...
            <section class="services">
                <div class="container">
                    ...
                    <div class="services-grid">
                        ...
                        <div class="service-card fade-in">
                            <div class="service-image">
                                <img src="public/images/sauna-6766761_1280.jpg" alt="Hot Stone Therapy" loading="lazy">
                            </div>
                            <div class="service-icon">
                    ...
                    <div class="contact-content">
                        ...
                        <div class="contact-info fade-in">
                            ...
                            <div class="contact-info">
                                <p><i class="fas fa-map-marker-alt"></i> 123 Wellness Avenue<br>Peaceful City, State 12345</p>
                                <p><i class="fas fa-phone"></i> (555) 123-4567</p>
                                <p><i class="fas fa-envelope"></i> info@serenityspa.com</p>
                ...
                <div class="container">
                    ...
                    <div class="contact-content">
                        ...
                        <div class="contact-info fade-in">
                            ...
                            <div class="contact-info">
                                <p><i class="fas fa-info-circle"></i> <strong>Booking Policy:</strong><br>
                                Appointments can be cancelled or rescheduled up to 24 hours in advance.</p>
                                
                                <p><i class="fas fa-credit-card"></i> <strong>Payment:</strong><br>
                                We accept cash, all major credit cards, and gift certificates.</p>
                                
                                <p><i class="fas fa-clock"></i> <strong>Arrival:</strong><br>
                                Please arrive 10 minutes early for your appointment.</p>
                                
                                <p><i class="fas fa-phone"></i> <strong>Questions?</strong><br>
                                Call us at (555) 123-4567</p>
                            </div>
    ...
    handleBookingSubmit(form) {
        ...
        alert(`Thank you for your booking request! We will confirm your appointment for ${data.date} at ${data.time} via email or phone.`);
        form.reset();
    }
}
